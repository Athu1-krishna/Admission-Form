      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="buttons">
          ...
          <Stack direction="row" spacing={2}>
            <Button type='submit' variant="contained" style={{ backgroundColor:'#1ab01f'}}>Register</Button>
            <Button onClick={handleReset} variant="contained" style={{ backgroundColor:'#fb3315' }}>Cancel</Button>
          </Stack>
        </div>
      </form>
    </div>
